  ...
  return (
    <div className="bg-[#050458] whitespace-nowrap text-white flex flex-col lg:flex-row sticky top-0 z-20">
      ...
      <div className={`${menuOpen ? "flex" : "hidden"} relative flex-col gap-5 bg-[#050465] lg:bg-[#050458] lg:flex lg:gap-10 py-5 lg:items-center lg:flex-row lg:justify-around`}>
        ...
        <NavLink
          to="/search"
          className="cursor-pointer group transition duration-300 hover:text-orange-500 w-full flex items-center justify-center lg:w-auto"
          >
        ...
        >
          ...
          <NavLink className="cursor-pointer group transition duration-300 hover:text-orange-500  w-full flex items-center justify-center lg:w-auto" to ="/wishList">
            Wish List
            <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-orange-500"></span>
          </NavLink>
          <NavLink className="cursor-pointer group transition duration-300 hover:text-orange-500 w-full flex items-center justify-center lg:w-auto" to ="/orders">
            Orders
            <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-orange-500"></span>
          </NavLink>
          <NavLink className="cursor-pointer group transition duration-300 hover:text-orange-500 w-full flex items-center justify-center lg:w-auto" to="/cart">
            Cart 
        ...
        {userDetails.isAdmin && (
          <NavLink className="cursor-pointer group transition duration-300 hover:text-orange-500 w-full flex items-center justify-center lg:w-auto" to="/admin">
            Admin
            <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-orange-500"></span>
          </NavLink>
        )}
        ...
        <div className='bg-gradient-to-r from-transparent via-gray-500 to-transparent h-[2px] w-full lg:hidden'></div>
          ...
          <span className="group">
            <span className="hidden cursor-pointer group transition duration-300 hover:text-orange-500 w-full lg:flex items-center justify-center lg:w-auto">
              <AccountCircleIcon />
              <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-orange-500"></span>
            </span>
            <div
